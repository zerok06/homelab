...
4. **Dominio**: asigna `nombre.kantu.lan` a cada recurso (ver [docs/08-recursos.md](08-recursos.md)).
...
- **Nunca expongas Coolify a Internet.** El acceso es únicamente `http://console.kantu.lan:8000` por VPN.
